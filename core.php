...
<head>
    ...
    <meta name="author" content="Web Protector">
    <META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
	<meta name="theme-color" content="#000000">
    <link rel="shortcut icon" href="assets/img/favicon.png">
    <title>Web Protector &rsaquo; Admin Panel</title>
...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="View Site" data-toggle="tooltip" data-placement="bottom">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link">
      <span class="brand-text font-weight-light"><i class="fab fa-get-pocket"></i> Web Protector</span>
    </a></center>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> <a href="#" target="_blank">Web Protector</a> v<?php echo $psec_version; ?></strong>
