...
if (isset($_POST['save'])) {
    ...
    if (isset($_POST['web-protector'])) {
        $settings['web-protector'] = 1;
    } else {
        $settings['web-protector'] = 0;
    }
...
?>" required>
                            ...
                            <div class="form-group">
								<label class="control-label">Web Protector</label><br />
								<input type="checkbox" name="web-protector" class="psec-switch" <?php
if ($settings['web-protector'] == 1) {
    echo 'checked';
}
?> />
...
?> />
									</br> Check if your website is correctly integrated with Web Protector.<br />
