...
$settings['webprotector_path'] = substr($fullpath, 0, strpos($fullpath, '/install'));
$settings['sqli_redirect']        = $settings['webprotector_path'] . '/pages/blocked.php';
$settings['proxy_redirect']       = $settings['webprotector_path'] . '/pages/proxy.php';
$settings['spam_redirect']        = $settings['webprotector_path'] . '/pages/spammer.php';
...
<div class="alert alert-success">
	Web Protector has been successfully installed on your website!
</div>
...
<b>Put the integration code in a main <i>.php</i> file of your website to integrate it with Web Protector.</b><br />
...
Change "<b>webprotector_folder</b>" with the path on which you installed the product)
<br /><br />
	<kbd>
	    include "webprotector_folder/config.php";<br />
	    include "webprotector_folder/web-protector.php";
	</kbd>
</div>
    
<a href="../" class="btn-success btn col-12"><i class="fas fa-arrow-circle-right"></i> Continue to Web Protector</a><br /><br />
</center>
<?php
footer();
?>