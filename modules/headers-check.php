...
if ($settings['badbot_protection3'] == 1) {
    ...
    if (empty($useragent)) {
        ...
        echo '<meta http-equiv="refresh" content="0;url=' . $settings['webprotector_path'] . '/pages/missing-useragent.php" />';
        exit;
    }
    ...
    if (!filter_var($ip, FILTER_VALIDATE_IP)) {
        ...
        echo '<meta http-equiv="refresh" content="0;url=' . $settings['webprotector_path'] . '/pages/invalid-ip.php" />';
        exit;
